...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState({
    ...
    "dependencyTreeRoots": [
      {
        "name": "yarn-interactive-link-repro",
        "reference": "workspace:."
      },
      {
    ...
    "fallbackExclusionList": [
      ["some-random-package-name", ["workspace:test"]],
      ["yarn-interactive-link-repro", ["workspace:."]]
    ],
    "fallbackPool": [
    ],
    ...
    "packageRegistryData": [
      [null, [
        [null, {
          "packageLocation": "./",
          "packageDependencies": [
            ["some-random-package-name", "link:./test::locator=yarn-interactive-link-repro%40workspace%3A."]
          ],
          "linkType": "SOFT",
        }]
      ]],
      ["some-random-package-name", [
        ["link:./test::locator=yarn-interactive-link-repro%40workspace%3A.", {
